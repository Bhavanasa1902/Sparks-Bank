...
<body>
    ...
    <class class="welcome">
        <h2>
            <img src="logos/logo5.png" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Money
                Transfer</strong> <img src="logos/logo3.png" alt="Bank" width="75" height="75">
        </h2>
    </class>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr style="color : black;">
                                    ...
                                    <td><a href="users.php?id= <?php echo $rows['id']; ?>"> <button class="btn btn-outline-dark ">View and Transact</button></a></td>
                                </tr>
                            <?php
                            }
                            ?>
